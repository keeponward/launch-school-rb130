...
def max_by(arr)
  largest_yield_value = nil
  largest_arr_value = nil
  arr.each_with_index do |num, index|
    this_yield_value = yield(num)
    if index == 0 || this_yield_value > largest_yield_value
      largest_yield_value = this_yield_value
      largest_arr_value = num
    end
  end
  largest_arr_value
end
